...
export function SupabaseIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="-4 -4 117 121" fill="none" stroke="currentColor" strokeWidth="7.3" strokeLinecap="round" strokeLinejoin="round" className={className}>
